...
- Grafana ([website](https://grafana.com/), [guide](https://grafana.com/docs/grafana/latest/setup-grafana/installation/docker/), [docker-compose.yml](https://github.com/grafana/loki/blob/main/production/docker-compose.yaml))
  - Use Loki for logging: [configure Loki datasource in Grafana](https://grafana.com/docs/grafana/latest/datasources/loki/configure-loki-data-source/) and [install the Loki Docker plugin](https://grafana.com/docs/loki/latest/send-data/docker-driver/).
  - [Configure Kamal logging to use Loki](https://gist.github.com/goofansu/792e70eddc5d313ff5428b299198d82f)
